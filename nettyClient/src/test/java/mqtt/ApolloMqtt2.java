...
public class ApolloMqtt2 {
    private static final Logger logger = LoggerFactory.getLogger(ApolloMqtt2.class);

    private static String mqttUri ="tcp://localhost:61613";
    private static String clientId = "test002";
    ...
    public static void main(String... args) throws Exception {
        init();
        Topic[] topics = {new Topic("mqtt/face/5f3df5ed043e5044f104ce65", QoS.AT_LEAST_ONCE),new Topic("CLOSE", QoS.AT_LEAST_ONCE)};
        ...
        Thread t1 = new Thread(new Runnable() {
            ...
            public void run() {
                while (true){
                    ...
                    logger.info("mqtt topic {} receive:{}",message.getTopic(),new String(payload));
                    message.ack();
                }
            }
        });
